        ...
        function ( $stateProvider, $urlRouterProvider ) {
            $stateProvider
                .state( 'contacts', {
                    ...
                    // 抽象设置为true,这意味着这种状态不能显式地激活。
                    //只能暗中激活激活它的一个孩子。
                    // TODO ??? 只能被继承显示???
                    abstract: true,

                    // This abstract state will prepend '/contacts' onto the urls of all its children.
                    // 他的抽象状态将预先考虑/接触到url的所有孩子。
                    url: '/contacts',

                    // Example of loading a template from a file. This is also a top level state,
                    // so this template file will be loaded and then inserted into the ui-view
                    // within index.html.
                    //从文件加载模板的例子。这也是一个顶级状态,
                    //这模板文件将被加载,然后插入到ui视图
                    // 在 index . html。
                    ...
                    //使用“resolve”来解决任何异步控制器依赖关系
                    // * before*控制器实例化之前。在这种情况下,因为联系人
                    //返回一个承诺,控制器将等到contacts.all()
                    //实例化之前解决。Non-promise返回值
                    //立即得到解决。
                    resolve: {
                        contacts: [ 'contacts',
                            function ( contacts ) {
                ...
                .state( 'contacts.detail', {
                    ...
                    views: {
                        ...
                        'hint@': {
                            template: '这是联系人。细节填充“hint”ui view'
                        },
