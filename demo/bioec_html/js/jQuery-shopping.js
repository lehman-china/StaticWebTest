				...
				addShoping:function(e){
					...
					if(dis){
						if ($('#floatOrder').length <= 0) {
							$('body').append('<div id="floatOrder"><img src="images/pro1.png" width="40" height="40" /></div');
						};
						var $obj=$('#floatOrder');
						if(!$obj.is(':animated')){
								...
								$obj.stop(false, false).animate({'top': Y-20,'opacity':0},500,function(){
									$obj.fadeOut(300,function(){
										...
										var l=$('.J-shoping-list').length,
											num=Number($num.text());
										if(l<5){
											$body.prepend('<div class="J-shoping-list" data-id="'+id+'"><p><a href="###">Kinase Inhibitor Library</a></p><p><b>￥500.00</b>25tests</p><div class="baseBg J-shoping-close"></div></div>');
										};
										$num.text(num+1);
									});
								});
